...
import com.galagaadventuregame.util.SystemUiHider;
 ...
 * @see SystemUiHider
 *      NOTE
 * Most code in this class and all classes in the com.galagaadventuregame.util package were provided by
 * the eclipse example project for android.  These classes do not add anything
 * to the program except for a visually pleasing start screen.
 *
 * ---------------------------------
 *
    ...
    extends Activity
{
    ...
    /**
     * @param savedInstanceState the instanceState to load
     */
    @Override
    ...
    // ---------------------------------------------------------------------
    /**
     * Listener for the start button, starts the WorldMapActivity
     */
    View.OnClickListener startButtonClicked = new View.OnClickListener() {
                                                public void onClick(View v)
                                                {
                                                    Intent myIntent = new Intent(StartscreenActivity.this, WorldMapActivity.class);
